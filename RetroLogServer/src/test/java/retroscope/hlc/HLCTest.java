...
public class HLCTest {
    ...
    public void testConvert() throws Exception {
        Timestamp t1 = new Timestamp(99152385159856128l);
        System.out.println(t1.getWallTime());
        System.out.println(t1.toString());
        Timestamp t2 = new Timestamp(99152385159790597l);
        System.out.println(t2.getWallTime());
