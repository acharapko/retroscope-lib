...
public class LessThanExpression extends CompareExpression
{
	...
	public LessThanExpression(Expression ex1, Expression ex2)
	{ 
		super(ex1, ex2);
	}
    ...
    protected boolean compareSets(RQLSet s1, RQLSet s2) throws IllegalExpressionException {
        throw new IllegalExpressionException("Less than is undefined for sets");
    }

    public LessThanExpression clone() {
        return new LessThanExpression(ex1.clone(), ex2.clone());
    }
}
